...
public class CommonPageObjects {
	...
	public void selectShowEntries(int entriesCount)
	{	
		Select selectEntriesCount = new Select(getSelectShowEntriesLocator());
		selectEntriesCount.selectByVisibleText(Integer.toString(entriesCount));
	}
	
	public int getRowCountTable()
	{
		List<WebElement> noOfRows = this.driver.findElements(By.xpath("//table/tbody//tr"));
